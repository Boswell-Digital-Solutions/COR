...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/cxSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** cx" "index designation"
require_contains "$PARTS_DIR/_index.md" "BDS Documentation Protocol v2.0" "index protocol"
require_contains "$PARTS_DIR/_index.md" 'Primary output: `doc/cxSYSTEM.md`' "index primary output"
require_contains "$PARTS_DIR/BUILD.sh" 'DESIGNATION="cx"' "build designation"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** cx" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" 'Primary output: `doc/cxSYSTEM.md`' "assembled primary output"
