...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/corSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** cor" "index designation"
require_contains "$PARTS_DIR/_index.md" "BDS Documentation Protocol v2.0" "index protocol"
require_contains "$PARTS_DIR/_index.md" 'Primary output: `doc/corSYSTEM.md`' "index primary output"
require_contains "$PARTS_DIR/BUILD.sh" 'DESIGNATION="cor"' "build designation"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** cor" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" 'Primary output: `doc/corSYSTEM.md`' "assembled primary output"
